...
results['ConstraintsDerivative0Count'] = results['ConstraintsCount'] - (results['ConstraintsDerivative1Count'] + results['ConstraintsDerivative2Count'])
results['ConstraintsViolatedDerivative0Count'] = results['ConstraintsViolated'] - (results['ConstraintsViolatedDerivative1Count'] + results['ConstraintsViolatedDerivative2Count'])
...
results['ConstraintsDerivative0Count'].fillna(1, inplace=True)
...
results['ConstraintsViolatedDerivative0Count'].fillna(1, inplace=True)
...
results['R2_Test'] = results['Test']

results['ConstraintsAchievedScaled'] = (1-(results['ConstraintsViolated']/results['ConstraintsCount']) ) * 100
results['ConstraintsAchievedDerivative0Scaled'] = (1-((results['ConstraintsViolated']-results['ConstraintsViolatedDerivative1Count']-results['ConstraintsViolatedDerivative2Count'])/results['ConstraintsCount'])) * 100
...
results['ConstraintsAchievedDerivative0Scaled'].fillna(0, inplace=True)
...
results = results[['EquationName','SampleSize','NoiseLevel', 'R2_Test',"ConstraintsAchievedScaled","ConstraintsAchievedDerivative0Scaled","ConstraintsAchievedDerivative1Scaled","ConstraintsAchievedDerivative2Scaled" ]]
